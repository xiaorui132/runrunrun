    ...
    <div class="container">
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="info" label="订单信息" width="150">
                <el-button type="primary" slot-scope="scope" @click="showOrderDetail(scope)">查看订单信息</el-button>
            </el-table-column>
            <el-table-column prop="starnum" label="评分"></el-table-column>
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <a @click="UpdateOrder(scope)">修改</a> |
    ...
    export default {
        ...
        methods: {
            ...
            async getOrder() {
                ...
                const { data: { data, count } } = await this.$http.get("http://localhost:3000/getAllOrder", {
            ...
            async deleteOrder({ row: { _id } }) {
                const { data } = await this.$http.get("http://localhost:3000/deleteOrder", {
                    params: {
                        _id
                    }
                });
